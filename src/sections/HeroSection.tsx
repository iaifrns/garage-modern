...
const HeroSection = () => {
  ...
  return (
    <div className="h-screen w-full" id="home">
      <div className="absolute h-full w-full bg-primary bg-opacity-20 max-md:bg-opacity-50">
        <div className="flex w-full justify-center items-center h-full">
          <div className="flex flex-col h-full w-full p-2 max-w-max-container">
            <TopMenu />
            <div className="h-full w-full flex flex-col gap-4 justify-center items-center  max-md:gap-8 p-4">
              <p className="text-secondary w-full font-semibold text-xl max-md:text-sm  max-md:text-center">
                ...
                <span className="text-white max-md:text-secondary">
                  {" "}
                  SERVICE
                </span>
              </p>
              ...
              <div className="flex flex-col gap-2 items-end max-md:items-center max-md:gap-4">
                <p className="text-white w-2/5 max-md:w-full max-md:text-sm font-semibold text-justify  max-md:text-center">
                  ...
                  savoir-faire et nos équipements de pointe, nous vous assurons
                  un service de qualité supérieure et une satisfaction garantie
                  à chaque visite.
                </p>
                <a
                  href="#services"
                  className="flex items-center justify-center p-2 bg-secondary w-[200px] text-primary font-bold"
                >
                  Nos Service
                </a>
              </div>
