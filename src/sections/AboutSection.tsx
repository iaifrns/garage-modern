...
const AboutSection = () => {
  return (
    <div className="bg-primary p-8 flex justify-center" id="about">
      <div className="mt-12 mb-12 w-full h-full flex max-md:flex-col max-md:gap-8 max-w-max-container">
