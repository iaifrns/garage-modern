...
const ServiceSection = () => {
  return (
    <div className="w-full h-[120vh] max-md:h-[2050px]" id="services">
      <div className="absolute w-full md:h-[120vh] max-md:h-[2050px] bg-primary bg-opacity-90">
        <div className="flex w-full h-full items-center justify-center">
          <div className="w-full h-[90%] max-md:h-full flex flex-col p-8 mt-8 mb-8 items-center gap-4 max-w-max-container">
      ...
      <img
        ...
        className="h-full w-full max-md:h-[2050px] max-md:object-cover"
      />
    </div>
  );
};
